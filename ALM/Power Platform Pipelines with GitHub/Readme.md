Please import the unmanaged solution PowerPipelinewithGitHub_1_0_0_3.zip to get the Power Automate Flow that gets triggered on Pre-Export step of the Power Platform Pipeline.
